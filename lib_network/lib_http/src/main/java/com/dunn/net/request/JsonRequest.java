...
public class JsonRequest {
     ...
     * @return
     */
    public static Request createRequest(String url, HttpMethodType methodType, String json) {
...
//        build.addHeader("api-version", "2");
     ...
     * @return
     */
    public static  Request createRequest(String url, HttpMethodType methodType, String json, HashMap<String, String> headerMap) {
        if (headerMap==null){
